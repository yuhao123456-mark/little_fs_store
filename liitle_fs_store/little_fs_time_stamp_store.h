#pragma once
/**
 * @file little_fs_time_stamp_store.h
 ...
 */
#include <stdint.h>
typedef enum __Little_fs_time_stamp_store_result
{
    Little_fs_time_stamp_store_result_success,
    Little_fs_time_stamp_store_result_unknown_error = -1,
} Little_fs_time_stamp_store_result;
/**
